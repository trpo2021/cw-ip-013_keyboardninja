...
LIB_SFML_SOURCES = $(shell find $(SFML_DIR)/$(SFML_INCLUDE) -name '*.$(HPP_EXT)')
LIB_SFML_OBJECTS = $(LIB_SOURCES:$(SFML_DIR)/$(SFML_INCLUDE)/%.$(HPP_EXT)=$(OBJ_DIR)/$(SRC_DIR)/%.o)
...
$(APP_PATH): $(APP_OBJECTS) $(LIB_PATH) $(LIB_SFML_OBJECTS) 
